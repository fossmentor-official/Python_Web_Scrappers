...
element = soup.select_one("tr.sorttop > th:nth-child(3)")
if element:
    ttlCase = element.text
else:
    ttlCase = "Element not found. Check the selector."

element = soup.select_one("tr.sorttop > th:nth-child(4)")
if element:
    ttlDeaths = element.text
else:
    ttlDeaths = "Element not found. Check the selector."

element = soup.select_one("tr.sorttop > th:nth-child(5)")
if element:
    ttlRecovered = element.text
else:
    ttlRecovered = "Element not found. Check the selector."
...
for i in range(3, 13, 1):
    element = soup.select_one(" tr:nth-child({}) > th:nth-child(2) > a".format(i))
    if element:
        country = element.text
    else:
        country = "Element not found. Check the selector."
        
    element = soup.select_one("tr:nth-child({}) > td:nth-child(3)".format(i))
    if element:
        ttlCase = element.text
    else:
        ttlCase = "Element not found. Check the selector."

    element = soup.select_one("tr:nth-child({}) > td:nth-child(4)".format(i))
    if element:
        ttlDeaths = element.text
    else:
        ttlDeaths = "Element not found. Check the selector."

    element = soup.select_one(" tr:nth-child({}) > td:nth-child(5)".format(i))
    if element:
        ttlRecovered = element.text
    else:
        ttlRecovered = "Element not found. Check the selector."
