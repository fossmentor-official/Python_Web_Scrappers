        ...
        for tournament in tournaments:
            ...
            for match in matches:
                ...
                schedule = match.find_all(
                    attrs={"class": "cb-col-100 cb-col cb-schdl cb-billing-plans-text"}
                )
                if schedule and schedule[0].h3:
                    ftitle = schedule[0].h3.text
                else:
                    ftitle = "The expected HTML element is not found."
